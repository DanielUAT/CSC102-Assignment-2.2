...
function chooseCoin(coin) // function to set chosen coin based on user input
{
    ...
    if (flippedCoin() == 1 && coin == 'heads') // if coin lands on heads and heads was chosen 
    {
    ...
    else if (flippedCoin() == 1 && coin == 'tails') // if coin lands on heads and tails was chosen 
    {
        totalHeads++; // increment total heads flipped by 1
    ...
    else if (flippedCoin() == 2 && coin == 'tails') // if coin lands on tails and tails was chosen
    {
    ...
    else if (flippedCoin() == 2 && coin == 'heads') // if coin lands on tails and heads was chosen
    {
        totalTails++; // increment total tails flipped by 1
        totalLosses++; // increment total losses by 1
    ...
    {
        document.getElementById("results").innerHTML = "Error: Invalid Input Flipped Coin " +flippedCoin() + " Please choose Heads or Tails. choosecoin "+ coin; // display error message
    } 
